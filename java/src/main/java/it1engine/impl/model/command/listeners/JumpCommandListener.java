...
public class JumpCommandListener implements CommandListenerInterface {

    private final Map<String, PieceInterface> pieces;
    private final BoardInterface board;
    private final CursorPositionManager cursorManager;

    public JumpCommandListener(Map<String, PieceInterface> pieces, BoardInterface board, CursorPositionManager cursorManager) {
        this.pieces = pieces;
        this.board = board;
    ...
    public boolean supports(CommandInterface cmd) {
        return cmd.getType().equalsIgnoreCase("JUMP");
    }
